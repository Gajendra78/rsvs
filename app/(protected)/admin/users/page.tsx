...
export default function UserManagementPage() {
  ...
  const handleOpenModal = (user?: User) => {
    if (user) {
      ...
      setEditingUser(null);
      // Default role is student, generate ID for it
      ...
      setFormData({
        ...
        role: defaultRole,
        status: 'active',
        validity: new Date(new Date().setFullYear(new Date().getFullYear() + 1)).toISOString().split('T')[0], // Default 1 year validity
        password: '',
      });
    }
    setIsModalOpen(true);
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-mono text-indigo-600 mt-0.5">{user.instituteId}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
